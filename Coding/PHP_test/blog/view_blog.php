...
<body>
    <div class="table-responsive">
        <div class="col-sm-4">
            ...
            <a href="add_blog.php" class="btn btn-info add-new"> Add new Blog</a>
        </div>
        <table class="table" style="margin: 10px;">
            ...
            <tbody>
                ...
                //$uid = "select id from user where email='$email'";
                //echo $uid;
                $sql="Select * from blog_post where userid=(select id from user where email='$email')";
