...
if(isset($_REQUEST['login']))
{
    ...
    $result = mysqli_query($con,"select email,password from user where email='$email' and password='$pass'");
	...
	if(is_array($row)) {
		...
		$sql="update user set lastlogin='$logindate' where email='$email'";
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <div class="form-group pb-4">
                            <button type="submit" onclick="login()" name="login" class="btn btn-primary  btn-block">Login</button>

                            <a class="btn btn-primary  btn-block" href="registration.php"> Registration</a>   
                        </div>
                  </div>
                </div>
            </div>
